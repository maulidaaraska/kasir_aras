            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="<?= base_url('home') ?>" class="app-brand-link">
                        <span class="app-brand-logo demo"><svg width="200" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                                <!-- Efek Kilauan - Belah ketupat -->
                                <filter id="glow">
                        ...
                        <span class="app-brand-text demo menu-text fw-bolder ms-2" style="text-transform: capitalize;">PureGlow</span>

                    </a>

                    <a href="<?= base_url('assets/sneat') ?>" class="layout-menu-toggle menu-link text-large ms-auto ">
                            ...
                            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                                    <div class="avatar avatar-online">
                                        <img src="<?= base_url('assets/sneat') ?>/assets/img/avatars/profil.jpg" alt="" class="w-px-40 h-auto rounded-circle">
                                    </div>
                                </a>
                    ...
                    <footer class="content-footer footer bg-footer-theme">
                        <div class="container-fluid d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                            <div class="mb-2 mb-md-0">
                                ...
                                , made with ❤️ by
                                <a href="https://themeselection.com" target="_blank" class="footer-link fw-bolder">Maulida Araska</a>
                            </div>
                        </div>
                    </footer>
                    <!-- / Footer -->
