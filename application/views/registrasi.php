          ...
          <div class="card-body">
            ...
            <div class="app-brand justify-content-center">
              <a href="index.html" class="app-brand-link gap-2">
                ...
                <span class="app-brand-text demo text-body fw-bolder">Flaspay</span>
              </a>
            </div>
            <!-- /Logo -->
            <h4 class="mb-2">Silahkan membuat akun 🚀</h4>
            <p class="mb-4">Hanya untuk admin!</p>
            ...
            <form id="formAuthentication" class="mb-3" action="index.html" method="POST">
              ...
              <div class="mb-3">
                ...
                <label name="level" class="form-control" name="level" value="Admin">Admin</label readonly>
              </div>
